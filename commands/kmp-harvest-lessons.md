...
skill improvements to upstream back into kmp-agent-skills.
...
HOW TO APPLY:
  From inside kmp-agent-skills:
    /kmp-modify-skill <skill slug>
...
NEXT STEPS:
  ...
  2. Run /kmp-modify-skill <skill> for each NEW/ENHANCEMENT
  3. After updating skills, run /kmp-release-notes and release
═══════════════════════════════════════════════════════
```
...
- Run from inside a consumer project (not from kmp-agent-skills itself)
